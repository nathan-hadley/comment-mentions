...
describe('CommentComponent', () => {
  ...
  describe('#detectMentions', () => {
    beforeEach(() => {
      const mockGetComputedStyle: typeof getComputedStyle = (
        elt: Element,
    ...
    it('should update filteredUsers when new character after "@" matches user names', () => {
      ...
      component.detectMention(inputEvent as any);
      const kevinExists = component.filteredUsers.some(
  ...
  describe('Arrow key navigation', () => {
    beforeEach(() => {
      ...
      component.mentionList =
        fixture.debugElement.nativeElement.querySelector('#mentionList');
    });
